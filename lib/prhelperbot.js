...
var closedAttachment = function closedAttachment(prData) {
  var message = prData && prData.merged_by.login ? (0, _helpers.getSlackName)(prData.merged_by.login) + " merged " + (0, _helpers.getSlackName)(prData.user.login) + "'s pull request." : "A pull request was merged.";
  return {
    link_names: "1",
    as_user: "true",
    attachments: [{
